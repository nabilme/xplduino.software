...
void enc28j60InitWithCs( uint8_t* macaddr, uint8_t csPin )
{
	...
	// enc28j60Write(ERXFCON, ERXFCON_UCEN|ERXFCON_CRCEN|ERXFCON_PMEN);
	enc28j60Write(ERXFCON, ERXFCON_UCEN|ERXFCON_CRCEN|ERXFCON_PMEN|ERXFCON_BCEN); // TODO: modif romain pour autoriser aussi le broadcast
	// enc28j60Write(ERXFCON, ERXFCON_BCEN); // TODO: modif romain pour n'autoriser que le broadcast
	...
	// enable automatic padding to 60bytes and CRC operations TODO: romain controle ca
